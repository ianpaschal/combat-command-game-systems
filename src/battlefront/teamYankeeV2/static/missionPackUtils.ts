...
import {
  createGetMissionMatrixOptions,
} from '../../_shared/_internal/createGetMissionMatrixOptions';
import { createGetMissionOptions } from '../../_shared/_internal/createGetMissionOptions';
import {
  createGetMissionOutcomeTypeOptions,
} from '../../_shared/_internal/createGetMissionOutcomeOptions';
