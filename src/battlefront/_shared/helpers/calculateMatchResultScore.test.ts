...
describe('calculateMatchResultScore()', () => {
  ...
  it('returns 8:1 when player 0 wins with less than 2 units lost.', () => {
    const details = {
      winner: 0,
      player0UnitsLost: 1,
      player1UnitsLost: 5,
  ...
  it('returns 7:2 when player 0 wins with 2 units lost.', () => {
    const details = {
      winner: 0,
      player0UnitsLost: 2,
      player1UnitsLost: 5,
  ...
  it('returns 6:3 when player 0 wins with 3 or more units lost.', () => {
    const details = {
      winner: 0,
      player0UnitsLost: 3,
      player1UnitsLost: 5,
  ...
  it('returns 1:8 when player 1 wins with less than 2 units lost.', () => {
    const details = {
      winner: 1,
      player1UnitsLost: 1,
      player0UnitsLost: 5,
  ...
  it('returns 2:7 when player 1 wins with 2 units lost.', () => {
    const details = {
      winner: 1,
      player1UnitsLost: 2,
      player0UnitsLost: 5,
  ...
  it('returns 3:6 when player 1 wins with 3 or more units lost.', () => {
    const details = {
      winner: 1,
      player1UnitsLost: 3,
      player0UnitsLost: 5,
  ...
  it('returns a draw score based on units lost.', () => {
    const details = {
      winner: -1,
      player0UnitsLost: 2,
      player1UnitsLost: 3,
  ...
  describe('with a scoreOverride', () => {
    it('returns override scores when scoreOverride is provided.', () => {
      const details = {
        winner: 0,
        player0UnitsLost: 1,
        player1UnitsLost: 5,
    ...
    it('returns override scores even when winner would normally give different scores.', () => {
      const details = {
        winner: 1,
        player0UnitsLost: 5,
        player1UnitsLost: 1,
    ...
    it('returns override scores even for draw scenarios.', () => {
      const details = {
        winner: -1,
        player0UnitsLost: 2,
        player1UnitsLost: 3,
    ...
    it('returns override scores with zero values.', () => {
      const details = {
        winner: 0,
        player0UnitsLost: 1,
        player1UnitsLost: 5,
    ...
    it('returns override scores with negative values.', () => {
      const details = {
        winner: 1,
        player0UnitsLost: 5,
        player1UnitsLost: 1,
