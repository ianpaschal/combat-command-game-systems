...
describe('FlamesOfWarV4.extractMatchResultStats', () => {

  it('should return the correct number of wins for each player.', () => {
    const details = {
      winner: 1,
  ...
  it('should return the correct number of units destroyed and lost for each player.', () => {
    const details = {
      player0UnitsLost: 2,
      player1UnitsLost: 4,
    } as MatchResultDetails;
  ...
  it('should return the correct number of points for each player.', () => {
    const details = {
      winner: 0,
      player0UnitsLost: 3,
      player1UnitsLost: 6,
  ...
  it('should return a tuple with exactly two BaseStats objects.', () => {
    const details = {
      winner: 0,
      player0UnitsLost: 1,
      player1UnitsLost: 2,
