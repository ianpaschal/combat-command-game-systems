...
describe('calculateMatchResultDetails', () => {
  ...
  it('should return empty object when mission is null.', () => {
    const result = calculateMatchResultDetails(null, {});

    expect(result).toEqual({});
  });

  it('should return empty object when all sub-utilities return undefined.', () => {
    const mission = {
  ...
  it('should return only attacker when only calculateMatchResultAttacker returns a value.', () => {
    const mission = {
  ...
  it('should return only firstTurn when only calculateMatchResultFirstTurn returns a value.', () => {
    const mission = {
      attacker: 'roll' as const,
  ...
  it('should return only winner when only calculateMatchResultWinner returns a value.', () => {
    const mission = {
      attacker: 'roll' as const,
      firstTurn: 'roll' as const,
  ...
  it('should return all computed details when all sub-utilities return values.', () => {
    const mission = {
      attacker: 'battle_plan' as const,
      firstTurn: 'attacker' as const,
      victoryConditions: [MatchOutcomeType.AttackRepelled],
