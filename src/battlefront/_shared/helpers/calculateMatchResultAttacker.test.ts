...
describe('calculateMatchResultAttacker()', () => {
  ...
  it('returns undefined when the mission is null.', () => {
    const result = calculateMatchResultAttacker(null);
    expect(result).toBeUndefined();
  });

  it('returns undefined when battle plans are missing.', () => {
    const mission = {
  ...
  it('returns undefined when mission attacker is "roll".', () => {
    const mission = {
  ...
  it('returns undefined when both players have the same battle plan.', () => {
    const mission = {
      attacker: 'battle_plan' as const,
    } as MissionData;
  ...
  it('returns the player with the "more aggressive" battle plan in asymmetrical match ups.', () => {
    const mission = {
      attacker: 'battle_plan' as const, 
    } as MissionData;
